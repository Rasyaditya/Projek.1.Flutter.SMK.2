...
class TambahPengurus extends StatelessWidget {
  const TambahPengurus({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Tambahan Pengurus Hotel'),
        elevation: 0,
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  TextField(
                    controller: clickController.idPengurus,
                  ),
                  TextField(
                    controller: clickController.namaPengurus,
                  ),
                  ElevatedButton(
                      onPressed: () {
                        clickController.addPengurus(
                            clickController.idPengurus.text,
                            clickController.namaPengurus.text);
                        Get.to(() => CatDashboard());
                      },
                      child: Text('Submit'))
                ],
